...
class Tree {
 ...
 /**
	...
	*/
	public function get_parent($myid){
		...
		$_pid = $this->arr[$pid]['id'];
		if(is_array($this->arr)){
			foreach($this->arr as $id => $a){
				if($a['id'] == $_pid) $newarr[$id] = $a;
			}
		}
		$newarr[$myid] = $this->arr[$myid];
		return $newarr;
	}
 ...
 /**
	...
	*/
	 ...
	 * @return array
	 */
	public function get_all_child($myid, $par='id')
	{
		$list = array();
		if(is_array($this->arr)){
			foreach($this->arr as $child){
				if($child['parent_id'] == $myid){
					$list[$child[$par]] = $child;
					$list[$child[$par]]['children'] = $this->get_all_child($child[$par]);
				}
			}
		}
